...
public class LoadingView extends View {
    ...
    // 颜色渐变
    private final SeekBarWidget.ColorTransition ct;
    ...
    public LoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.ct = new SeekBarWidget.ColorTransition(Color.parseColor("#00000000"), backgroundMaskColor);
    ...
    private void upgradeColors() {
        final SeekBarWidget.ColorTransition tempCt = new SeekBarWidget.ColorTransition(
